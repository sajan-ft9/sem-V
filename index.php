        ...
        <div class="container">
            <div class="row">
                ...
                <?php
                    ...
                    $three_products = array_slice($all_products,0,3);
                    foreach ($three_products as $single_product):
                ?>
                    <div class="card mt-2 mb-2">
                        <figure class="itemside">
                            ...
                            <figcaption class="p-3">
                                <h6 class="title"><a href="#"><?=$single_product['product_name']?></a></h6>
                                <div class="price-wrap">
                                    <span class="price-new b"><?="Rs. ".$single_product['price']?></span>
